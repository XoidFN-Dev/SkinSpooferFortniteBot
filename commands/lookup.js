    ...
    try {
      ...
      if (response.status === 200) {
        ...
        switch (platformName) {
          ...
          default:
            imageUrl =
              "https://static-00.iconduck.com/assets.00/question-mark-inverse-major-icon-2048x2048-2b54517l.png";
        }
        ...
        interaction.reply(
          "❌ Failed to retrieve account ID. The username you're trying to search may be private."
        );
      }
    } catch (error) {
      console.error(error);
